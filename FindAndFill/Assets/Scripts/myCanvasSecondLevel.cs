...
public class myCanvasSecondLevel : MonoBehaviour {
    ...
    public  void Awake() {
        ...
        if (FindObjectsOfType(GetType()).Length > 1) {
         ...
         void Update () {
		if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 3 || UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 4 || UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 5) {
			myGm.SetActive(true);
